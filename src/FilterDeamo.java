...
public class FilterDeamo {
	public static void main(String[] args) {
		...
		List<Person> person_list = Arrays.asList(
				new Person("Satish", "101", "EEE"),
				new Person("Satish1", "102", "ECE"),
				new Person("Satish2", "103", "MEC")
		);
		 ...
		 */
		/*
		 * String st1=Nameslist.stream().filter(names ->
		 * names.startsWith("s")).findAny().orElse(null); System.out.pr
		 */
